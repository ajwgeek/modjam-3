 ...
 */
public class QuestPageButcher extends QuestPage implements IQuestPage
{
	/* Kill sheep quest */
	...
	public static final Quest killSheep = (new Quest("Shearing", "Kill 3 sheep and collect the wool.", 0, 0, new ItemStack(Block.cloth), new QuestPageButcher(), (Quest) null,
	...
	public static final Quest sleep = (new Quest("Counting Sheep", "Craft a bed from harvested wool", -2, 2, new ItemStack(Item.bed), new QuestPageButcher(), killSheep,
	...
	public static final Quest colorful = (new Quest("Colorful", "Obtain 16 dye powder", 0, 2, new ItemStack(Item.dyePowder), new QuestPageButcher(), killSheep, colorfulTools,
	...
	public static final Quest niceFloors = (new Quest("Nice Floors", "Craft 16 carpets", 0, 4, new ItemStack(Block.carpet), new QuestPageButcher(), colorful, niceFloorsTools,
			colorfulItems, colorfulReward, Tracker.ITEMTURNIN, 0, 0, 0, 0));
	...
	public static final Quest killCows = (new Quest("Kill Cows", "Collect 3 steaks", 2, 0, new ItemStack(Item.beefRaw), new QuestPageButcher(), null, killCowsTools, killCowsItems,
	...
	public static final Quest tBoneSteak = (new Quest("T-Bone Steak", "Cook three steaks", 2, 2, new ItemStack(Item.beefCooked), new QuestPageButcher(), killCows, tBoneSteakTools,
	...
	public static final Quest milk = new Quest("Milk", "Collect a bucket of milk", 2, 4, new ItemStack(Item.bucketMilk), new QuestPageButcher(), tBoneSteak, milkTools, milkItems,
	...
	public static final Quest killPig = new Quest("Kill Pigs", "Kill 3 pigs and collect the meat", 4, 0, new ItemStack(Item.porkRaw), new QuestPageButcher(), null, killPigTools, killPigsItems, killPigsReward, Tracker.ITEMTURNIN, 0, 0, 0, 0);
	...
	public static final Quest juicyMeat = new Quest("Juicy Meat", "Cook 3 raw porkchops", 4, 2, new ItemStack(Item.porkCooked), new QuestPageButcher(), killPig, juicyMeatTools, juicyMeatItems, juicyMeatReward, Tracker.ITEMTURNIN, 0, 0, 0, 0);
	...
	public static final Quest killChickens = new Quest("Kill Chickens", "Kill 3 chickens and collect the meat", 6, 0, new ItemStack(Item.chickenRaw), new QuestPageButcher(), null, killChickenTools, killChickenItems, killChickenRewards, Tracker.ITEMTURNIN, 0, 0, 0, 0);
	...
	public static final Quest kfc = new Quest("KFC", "Cook 3 raw chickens", 6, 2, new ItemStack(Item.chickenCooked), new QuestPageButcher(), killChickens, kfcTools, kfcItems, kfcRewards, Tracker.ITEMTURNIN, 0, 0, 0, 0);
	...
	public static final Quest eggs = new Quest("Collect Eggs", "Collect 16 eggs", 8, 2, new ItemStack(Item.egg), new QuestPageButcher(), killChickens, eggTools, eggItems, eggRewards, Tracker.ITEMTURNIN, 0, 0, 0, 0);
	...
	public static final Quest celebrate = new Quest("Celebrate", "Bake a cake", 8, 4, new ItemStack(Item.cake), new QuestPageButcher(), eggs, celebrateTools, celebrateItems, celebrateRewards, Tracker.ITEMTURNIN, 0, 0, 0, 0);
