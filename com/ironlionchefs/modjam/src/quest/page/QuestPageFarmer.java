...
/*
 * Quests given by the farmer
 */
public class QuestPageFarmer extends QuestPage implements IQuestPage
{
	/* Logging Quest */
	private static ItemStack[] loggingTools = null;
	...
	public static final Quest logging = (new Quest("Logging", "Cut down 64 logs and collect 8 saplings", 0, 0, new ItemStack(Block.wood), new QuestPageFarmer(), (Quest) null,
			loggingTools, loggingReqdItems, loggingReward, Tracker.ITEMTURNIN, 0, 0, 0, 0));
	
	
	/* Make Small Orchard Quest */
	private static ItemStack[] makeSmallOrchardTools = new ItemStack[] { new ItemStack(Block.sapling, 8) };
	...
	public static final Quest makeSmallOrchard = (new Quest("Make Small Orchard", "Plant 8 saplings in a small orchard", 0, 2, new ItemStack(Block.sapling),
			new QuestPageFarmer(), logging, makeSmallOrchardTools, makeSmallOrchardReqdItems, makeSmallOrchardReward, Tracker.BLOCKPLACED, 8, Block.sapling.blockID, 0, 0));
	
	
	/* Gather Apples Quest */
	private static ItemStack[] gatherApplesTools = null;
	...
	public static final Quest gatherApples = (new Quest("Gather Apples", "Gather 16 apples from the orchard", 0, 4, new ItemStack(Item.appleRed), new QuestPageFarmer(),
	...
	public static final Quest renewableFood = (new Quest("Renewable Food", "Gather 64 seeds", -2, 2, new ItemStack(Item.seeds), new QuestPageFarmer(), logging,
			renewableFoodTools, renewableFoodReqdItems, renewableFoodReward, Tracker.ITEMTURNIN, 0, 0, 0, 0));
	
	
	/* Make Wheat Farm Quest */
	private static ItemStack[] makeWheatFarmTools = new ItemStack[] { new ItemStack(Item.seeds, 64) };
	...
	public static final Quest makeWheatFarm = (new Quest("Make Wheat Farm", "Plant 64 seeds in a small wheat farm", -2, 4, new ItemStack(Item.wheat), new QuestPageFarmer(),
	...
	private static ItemStack[] stealPotatoesTools = null;
	...
	public static final Quest stealPotatoes = (new Quest("Steal Potatoes", "Raid another village and steal 32 potatoes.", -4, 4, new ItemStack(Item.poisonousPotato),
			new QuestPageFarmer(), makeWheatFarm, stealPotatoesTools, stealPotatoesReqdItems, stealPotatoesReward, Tracker.ITEMTURNIN, 0, 0, 0, 0));
	
	
	/* Plant Potatoes Quest */
	private static ItemStack[] plantPotatoesTools = new ItemStack[] { new ItemStack(Item.potato, 32) };
	...
	public static final Quest plantPotatoes = (new Quest("Plant Potatoes", "Plant 32 potato plants", -6, 4, new ItemStack(Item.potato), new QuestPageFarmer(), stealPotatoes,
			plantPotatoesTools, plantPotatoesReqdItems, plantPotatoesReward, Tracker.BLOCKPLACED, 32, Item.potato.itemID, 0, 0));
	
	
	/* Steal Carrots Quest */
	private static ItemStack[] stealCarrotsTools = null;
	...
	public static final Quest stealCarrots = (new Quest("Steal Carrots", "Raid another village and steal 32 potatoes", -2, 6, new ItemStack(Item.carrotOnAStick),
			new QuestPageFarmer(), makeWheatFarm, stealCarrotsTools, stealCarrotsReqdItems, stealCarrotsReward, Tracker.ITEMTURNIN, 0, 0, 0, 0));
	
	
	/* Plant Carrots Quest */
	private static ItemStack[] plantCarrotsTools = new ItemStack[] { new ItemStack(Item.carrot, 32) };
	...
	public static final Quest plantCarrots = (new Quest("Plant Carrots", "Plant 32 carrot plants", -2, 8, new ItemStack(Item.carrot), new QuestPageFarmer(), stealCarrots,
			plantCarrotsTools, plantCarrotsReqdItems, plantCarrotsReward, Tracker.BLOCKPLACED , 32, Item.carrot.itemID, 0, 0));
	
	
	/* Find Dungeon Quest */
	private static ItemStack[] findDungeonTools = null;
	...
	public static final Quest findDungeon = (new Quest("Find Dungeon", "Find a dungeon and break the monster spawner", 2, 0, new ItemStack(Item.saddle),
			new QuestPageFarmer(), (Quest) null, findDungeonTools, findDungeonReqdItems, findDungeonReward, Tracker.BLOCKBROKEN, 0, 0, 1, Block.mobSpawner.blockID));
	
	
	/* Farm From Hell Quest */
	private static ItemStack[] farmFromHellTools = new ItemStack[] { new ItemStack(Block.mobSpawner, 1) };
	...
	public static final Quest farmFromHell = (new Quest("Farm From Hell", "Create an XP farm", 2, 2, new ItemStack(Block.mobSpawner),
			new QuestPageFarmer(), findDungeon, farmFromHellTools, farmFromHellReqdItems, farmFromHellReward, Tracker.BLOCKPLACED, 1, Block.mobSpawner.blockID, 0, 0));
	
	
	/* Gather Golden Apples Quest */
	private static ItemStack[] gatherGoldApplesTools = null;
	...
	public static final Quest gatherGoldApples = (new Quest("Curative", "Search dungeons for a golden apple", 3, 1, new ItemStack(Item.appleGold), new QuestPageFarmer(),
			(Quest) null, gatherGoldApplesTools, gatherGoldApplesReqdItems, gatherGoldApplesReward, Tracker.ITEMTURNIN, 0, 0, 0, 0));
	
	
	/* Melon Farm Quest */
	private static ItemStack[] melonSeedsTools = null;
	...
	public static final Quest melonSeeds = (new Quest("Melon Farm", "Search dungeons for a 4 melon seeds and plant them", 5, 1, new ItemStack(Block.melon),
			new QuestPageFarmer(), (Quest) null, melonSeedsTools, melonSeedsReqdItems, melonSeedsReward, Tracker.BLOCKPLACED, 4, Item.melonSeeds.itemID, 0, 0));
	
	
	/* Pumpkin Patch Quest */
	private static ItemStack[] pumpkinSeedsTools = null;
	...
	public static final Quest pumpkinSeeds = (new Quest("Pumpkin Patch", "Search dungeons for 4 pumpkin seeds and plant them", 4, 1, new ItemStack(Block.pumpkin),
			new QuestPageFarmer(), (Quest) null, pumpkinSeedsTools, pumpkinSeedsReqdItems, pumpkinSeedsReward, Tracker.BLOCKPLACED, 4, Item.pumpkinSeeds.itemID, 0, 0));
