...
public class QuestDataBlocksPlaced extends WorldSavedData
{
	public static final String IDENTIFIER = "QUEST_BLOCK_DATA";
	private Map<String, Integer> blockMap = new HashMap<String, Integer>();

	public QuestDataBlocksPlaced()
	{
		super(IDENTIFIER);
	}

	public QuestDataBlocksPlaced(String s)
	{
		super(IDENTIFIER);
	}
	...
	public static QuestDataBlocksPlaced forWorld(World world)
	{
		QuestDataBlocksPlaced d = (QuestDataBlocksPlaced) world.mapStorage.loadData(QuestDataBlocksPlaced.class, IDENTIFIER);
		if (d == null)
		{
			d = new QuestDataBlocksPlaced();
