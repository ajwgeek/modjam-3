...
public class PacketRequestConsumeFromInventory extends PacketBase
{
	public String username;
	public int itemID;

	public PacketRequestConsumeFromInventory(EntityPlayer ep, int itemID)
	{
		this.username = ep.username;
		this.itemID = itemID;
	}

	public PacketRequestConsumeFromInventory()
	{
	}
